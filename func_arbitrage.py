        ...
        for pair_b in pairs_list:
            ...
            if pair_b != pair_a:
                if b_base in a_pair_box or b_quote in a_pair_box:
                    ...
                    # Initialize counts_c_base and counts_c_quote
                    counts_c_base = 0
                    counts_c_quote = 0
...
#Structure Prices
def fet_price_for_t_pair(t_pair, prices_json):
...
def calc_triangular_arb_surface_rate(t_pair, prices_dict):
    ...
    for direction in direction_list:
        ...
        # Assume starting with a_base and swapping for a_quote
        if direction == "reserse":
            swap_1 = a_quote
            swap_2 = a_base
            swap_1_rate = a_bid
            direction_trade_1 = "base_to_base"
        ...
        if direction == "forward":
            if a_quote == b_quote and calculated == 0:
                ...
                if b_base == c_base:
                    swap_3 = c_baseswap_3_rate = 1 / c_ask
